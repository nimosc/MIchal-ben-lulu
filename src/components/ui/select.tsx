...
function highlightSelectItem(el: HTMLElement, clientX: number, clientY: number) {
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}
      onPointerEnter={(e) => {
        highlightSelectItem(e.currentTarget as HTMLElement, e.clientX, e.clientY)
